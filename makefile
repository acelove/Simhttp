object = src/main.o src/master.o src/worker.o src/listener.o src/connection.o src/http.o lib/http-parser/http_parser.o
CFLAGS=-I./include -I./lib/http-parser/
simhttp : src/main.o src/master.o src/worker.o src/listener.o src/connection.o src/http.o lib/http-parser/http_parser.o
	g++ -g -o $@ src/main.o src/master.o src/worker.o src/listener.o src/connection.o src/http.o lib/http-parser/http_parser.o -levent
